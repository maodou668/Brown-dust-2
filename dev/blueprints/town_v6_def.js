...
module.exports = { stage: {
  ...
  map: {
    tile: 32,
    layers: [
      { sheet: T2 + 'sickgrass_d2.png', fullVar: [[0, 96]] },
      { sheet: T2 + 'water_s.png',     lut: T2 + 'water_s.lut.json',     grid: waterGrid },
      { sheet: T2 + 'deadfield_s.png', lut: T2 + 'deadfield_s.lut.json', grid: farmGrid },
      { sheet: T2 + 'sickgrass_d2.png', lut: T2 + 'sickgrass_d2.lut.json', grid: mudGrid },
      { sheet: T2 + 'flagstone_s.png', lut: T2 + 'flagstone_s.lut.json', grid: flagGrid },
    ],
  },
  props: [
    // ---- 村西口: 栅门(等距合身度待目检) ----
    ...
    { img: P + 'tree_oak.png',  x: 30,   y: 2.0, s: 0.62 },
    ...
    { img: P + 'tree_oak.png',  x: 28.6, y: 24.6, s: 0.66 },
    { img: P + 'tree_oak.png',  x: 34.5, y: 25.2, s: 0.7 },
    // 东岸坡地树(把磨坊围出孤立感)
    { img: P + 'tree_dead.png', x: 43.5, y: 3.2, s: 0.7 },
    { img: P + 'tree_oak.png',  x: 47,   y: 2.4, s: 0.65 },
    { img: P + 'tree_dead.png', x: 50.5, y: 5,   s: 0.72 },
    { img: P + 'tree_dead.png', x: 50.8, y: 12,  s: 0.6 },
    { img: P + 'tree_oak.png',  x: 49.5, y: 18,  s: 0.78 },

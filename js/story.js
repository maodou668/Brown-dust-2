...
const STORY = {
  ...
  prologue: [
    ...
    { bg: 'void', text: '阿斯忒拉大陆的天空，开始落下细密的、褐色的尘。' },
    { bg: 'void', text: '那不是沙，不是灰。那是被魔物夺去了「色彩」的世界，正一寸寸崩解成的粉末。' },
    { bg: 'void', text: '草化作褐尘，木化作褐尘……连人，也会化作褐尘。' },
    { bg: 'castle', text: '魔物的潮水中，魔王巴尔自封印中苏醒，吞噬着边境的村庄。' },
    { bg: 'town', text: '人们将最后的希望，寄托于各地的佣兵团。' },
    ...
    { clear: true, bg: 'forest', text: '那个旅人始终立在泰瑞德身后半步，不出手，只是说话。每一句，都恰好早于危险半拍。' },
    { bg: 'forest', text: '当最后一只魔物化作褐尘、被风卷散时，泰瑞德一屁股坐倒在地，却咧开嘴笑了。' },
    ...
    { clear: true, bg: 'forest', text: '大陆历一〇二四年的清晨，一支日后将被无数人传颂的佣兵团，以三个人的姿态，悄然诞生。' },
  ],
  ...
  stage3: [
    { bg: 'cave', text: '废弃矿洞深处，岩壁上爬满了褐色的尘——像活物一样，从石缝里渗出、蔓延。' },
  ...
  stage4: [
    { bg: 'ridge', text: '诅咒山脊。狂风裹着腐臭，被褐尘浸透了千年的巨魔王，缓缓睁开了眼。' },
  ...
  stage5: [
    { bg: 'castle', text: '魔王城，王座之间。城堡上空的褐尘浓得化不开，像一道永不天亮的、凝固的夜。' },

...
const SCRIPTS = {
  ...
  chapter1: [
    ...
    { op: 'scene', bg: 'town',
      stage: window.TOWN_STAGE = { bigmap: 'town_day', cam: { x: 9, y: 91 } },
      actors: {
        teried:   { sprite: 'teried',   x: 4,    y: 96,   dir: 'north-east', glow: true },
        mina:     { sprite: 'mina',     x: 2,    y: 98,   dir: 'north-east' },
        villager: { sprite: 'villager', x: 39.5, y: 44,   dir: 'south-west' },
      },
      steps: [
        { t: 'narr', text: '灰蒙蒙的上午。烟囱都冒着烟，栅墙外的枯树上一只鸟都没有。看上去是个活的村子。' },
        { t: 'camera', x: 19, y: 76, scale: 1, dur: 2600 },
        { t: 'move', who: 'teried', to: [15, 83], dur: 2600 },
        { t: 'move', who: 'mina',   to: [12.5, 86], dur: 2600 },
        { t: 'narr', text: '栅门虚掩着，门轴上了新油——推起来一点声音都没有。' },
        { t: 'camera', x: 37, y: 46, scale: 1, dur: 3200 },
        { t: 'move', who: 'teried', to: [19, 75.5], dur: 1500, dirLock: 'north-east' },
        { t: 'move', who: 'teried', to: [37.5, 46], dur: 2600 },
        { t: 'move', who: 'mina',   to: [17, 78.5], dur: 1600, dirLock: 'north-east' },
        { t: 'move', who: 'mina',   to: [34.5, 48], dur: 2600 },
